...
en el que si la derivada se encuentra saturada se obtienen valores muy chicos y esto conlleva a errores numericos en caso de que la entrada no este normalizada. Este fue un problema
